...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { date: @history.date, event: @history.event, owner: @history.owner } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { date: @history.date, event: @history.event, owner: @history.owner } }
